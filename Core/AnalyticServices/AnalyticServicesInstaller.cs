namespace Core.AnalyticServices
{
    ...
    public class AnalyticServicesInstaller : Installer<AnalyticServicesInstaller>
    {
        public override void InstallBindings()
        {
            ...
            this.Container.DeclareSignal<AdRevenueRequestSignal>();
            this.Container.DeclareSignal<AdRevenueLoadedSignal>();
            this.Container.DeclareSignal<AdRevenueClickedSignal>();
