namespace Core.AdsServices
{
    ...
    public struct AdScreenPosition
    {
        ...
        public static implicit operator Vector2(AdScreenPosition adScreenPosition)
        {
            return new Vector2(adScreenPosition.x, adScreenPosition.y);
        }

        public static bool operator ==(AdScreenPosition pos1, AdScreenPosition pos2)
        {
            return Vector2.Distance(pos1, pos2) < Mathf.Epsilon;
        }
        ...
        {
            return obj is AdScreenPosition position && this == position;
        }
