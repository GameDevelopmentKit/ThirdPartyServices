...
namespace ServiceImplementation.AdsServices.Yandex
{
    ...
    public class YandexAdsWrapper : IAdServices, IInitializable, IAdLoadService, IAOAAdService
    {
        ...
        public void Initialize()
        {
            ...
            this.logService.Log($"Yandex: Initialize SDK");
        }
        ...
        {
            this.logService.Log($"HandleBannerAdLoaded");
        ...
        {
            this.logService.Log($"Yandex: HandleBannerAdFailedToLoad {args.Message}");
        ...
        {
            this.logService.Log($"Yandex: HandleBannerAdClicked");
            var adInfo = new AdInfo(this.AdPlatform, this.YandexSettings.BannerAdId.Id, YandexAdsWrapper.BannerAdFormat, YandexAdsWrapper.BannerAdFormat);
        ...
        {
            this.logService.Log($"Yandex: HandleRewardedAdFailedToLoad: {args.Message}");
        ...
        {
            this.logService.Log($"Yandex: HandleRewardedAdDismissed");
        ...
        {
            this.logService.Log($"Yandex: HandleRewardedAdFailedToShow: {args.Message}");
            var adInfo = new AdInfo(this.AdPlatform, this.YandexSettings.RewardedAdId.Id, YandexAdsWrapper.RewardedAdFormat, YandexAdsWrapper.RewardedAdFormat);
        ...
        {
            this.logService.Log($"Yandex: HandleRewardedAdClicked");
            var adInfo = new AdInfo(this.AdPlatform, this.YandexSettings.RewardedAdId.Id, YandexAdsWrapper.RewardedAdFormat, YandexAdsWrapper.RewardedAdFormat);
        ...
        {
            this.logService.Log($"Yandex: HandleRewardedAdShown");
            var adInfo = new AdInfo(this.AdPlatform, this.YandexSettings.RewardedAdId.Id, YandexAdsWrapper.RewardedAdFormat, YandexAdsWrapper.RewardedAdFormat);
        ...
        {
            this.logService.Log($"Yandex: HandleRewardedAdReward");
        ...
        {
            this.logService.Log($"Yandex: HandleInterstitialLoaded, AdUnitId: {args.Interstitial.GetInfo().AdUnitId}");
        ...
        {
            this.logService.Log($"Yandex: HandleInterstitialDismissed");
            var adInfo = new AdInfo(this.AdPlatform, this.YandexSettings.InterstitialAdId.Id, YandexAdsWrapper.InterstitialAdFormat);
        ...
        {
            this.logService.Log($"Yandex: HandleInterstitialFailedToShow");
            this.DestroyInterstitial();
            this.LoadInterstitialAd();
        }
        ...
        {
            this.logService.Log($"Yandex: HandleInterstitialAdClicked");
            var adInfo = new AdInfo(this.AdPlatform, this.YandexSettings.InterstitialAdId.Id, YandexAdsWrapper.InterstitialAdFormat);
        ...
        {
            this.logService.Log($"Yandex: HandleInterstitialShown");
            var adInfo = new AdInfo(this.AdPlatform, this.YandexSettings.InterstitialAdId.Id, YandexAdsWrapper.InterstitialAdFormat);
        ...
        {
            this.logService.Log($"Yandex: HandleAoaAdLoaded");
        ...
        {
            this.logService.Log($"Yandex: HandleAoaAdFailedToLoad: {args.Message}");
            this.signalBus.Fire(new AppOpenLoadFailedSignal(""));
        }

        private void HandleAoaAdClicked(object sender, EventArgs args)
        {
            this.logService.Log($"Yandex: HandleAoaAdClicked");
            var adInfo = new AdInfo(this.AdPlatform, this.YandexSettings.AoaAdId.Id, AoaAdFormat);
        ...
        {
            this.logService.Log($"Yandex: HandleAoaAdShown");
            var adInfo = new AdInfo(this.AdPlatform, this.YandexSettings.AoaAdId.Id, AoaAdFormat);
        ...
        {
            this.logService.Log($"Yandex: HandleAoaAdDismissed");
            var adInfo = new AdInfo(this.AdPlatform, this.YandexSettings.AoaAdId.Id, AoaAdFormat);
        ...
        {
            this.logService.Log($"Yandex: HandleAdFailedToShow event received with message: {args.Message}");
