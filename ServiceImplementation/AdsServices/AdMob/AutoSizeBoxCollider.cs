namespace ServiceImplementation.AdsServices.AdMob
{
    ...
    public class AutoSizeBoxCollider : MonoBehaviour
    {
        ...
        private void OnEnable() { this.Box.size = new Vector3(this.Rect.rect.width, this.Rect.rect.height, this.zSize); }

        private void OnRectTransformDimensionsChange() { this.Box.size = new Vector3(this.Rect.rect.width, this.Rect.rect.height, this.zSize); }
    }
}