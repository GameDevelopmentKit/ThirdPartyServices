namespace ServiceImplementation.AdsServices.Gads
{
    ...
    public class GadsmeWrapper : IInitializable
    {
        #region Inject
        ...
        {
            //TODO: Implement impression event
            Debug.Log("Impression: " + obj);
        }
        ...
        {
            Debug.Log("Ad Content Loaded (" + info.adFormat.GetName() + ", " + info.adChannelNumber + ", " + info.lineItemType + ")");
        }

        private void OnAdContentVisible(GadsmeAdContentInfo info)
        {
            Debug.Log("Ad Content Visible (" + info.adFormat.GetName() + ", " + info.adChannelNumber + ", " + info.lineItemType + ")");
        }

        private void OnAdContentViewable(GadsmeAdContentInfo info)
        {
            Debug.Log("Ad Content Viewable (" + info.adFormat.GetName() + ", " + info.adChannelNumber + ", " + info.lineItemType + ")");
        }

        private void OnAdContentClicked(GadsmeAdContentInfo info)
        {
            Debug.Log("Ad Content Clicked (" + info.adFormat.GetName() + ", " + info.adChannelNumber + ", " + info.lineItemType + ")");
        }

        private void OnAdContentFailed(GadsmeAdContentInfo info)
        {
            Debug.Log("Ad Content Failed (" + info.adFormat.GetName() + ", " + info.adChannelNumber + ", " + info.lineItemType + ")");
        }

        private void OnLoadAudioAd(GadsmeAudioAdInfo info)
        {
            Debug.Log("Audio: load audio ad " + info);
        }

        private void OnCancelAudioAd(GadsmeAudioAdInfo info, GadsmeCancelAudioAdReason reason)
        {
            Debug.Log("Audio: cancel audio ad " + info + " (reason: " + reason + ")");
        }

        private void OnAudioAdReadyToPlay(GadsmeAudioAdInfo info)
        {
            Debug.Log("Audio: audio ad ready to play " + info);
        }

        private void OnPlayAudioAd(GadsmeAudioAdInfo info)
        {
            Debug.Log("Audio: play audio ad " + info);
        }

        private void OnAudioAdIncompletePlaythrough(GadsmeAudioAdInfo info)
        {
            Debug.Log("Audio: incomplete playthrough " + info);
        }

        private void OnFinishAudioAd(GadsmeAudioAdInfo info, bool complete)
        {
            Debug.Log("Audio: finish audio ad " + info + " (complete: " + complete + ")");
        }
