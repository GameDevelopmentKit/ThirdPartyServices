namespace ServiceImplementation.Configs.Ads
{
    ...
    public class AppLovinSettings : AdNetworkSettings
    {
        ...
        /// </summary>
        public CrossPlatformValue DefaultBannerAdId { get => this.mDefaultBannerAdId; set => this.mDefaultBannerAdId = value; }

        /// <summary>
        /// Gets or sets the default interstitial ad identifier.
        /// </summary>
        public CrossPlatformValue DefaultInterstitialAdId { get => this.mDefaultInterstitialAdId; set => this.mDefaultInterstitialAdId = value; }

        /// <summary>
        /// Gets or sets the default rewarded ad identifier.
        /// </summary>
        public CrossPlatformValue DefaultRewardedAdId { get => this.mDefaultRewardedAdId; set => this.mDefaultRewardedAdId = value; }

        /// <summary>
        /// Gets or sets the default AOA ad identifier.
        /// </summary>
        public CrossPlatformValue DefaultAOAAdId { get => this.mAOAAdId; set => this.mAOAAdId = value; }
        ...
        /// </summary>
        public override Dictionary<AdPlacement, CrossPlatformValue> CustomBannerAdIds { get => this.mCustomBannerAdIds; set => this.mCustomBannerAdIds = value as Dictionary_AdPlacement_AdId; }

        /// <summary>
        /// Gets or sets the list of custom interstitial ad identifiers.
        /// Each identifier is associated with an ad placement.
        /// </summary>
        public override Dictionary<AdPlacement, CrossPlatformValue> CustomInterstitialAdIds { get => this.mCustomInterstitialAdIds; set => this.mCustomInterstitialAdIds = value as Dictionary_AdPlacement_AdId; }

        /// <summary>
        /// Gets or sets the list of custom rewarded ad identifiers.
        /// Each identifier is associated with an ad placement.
        /// </summary>
        public override Dictionary<AdPlacement, CrossPlatformValue> CustomRewardedAdIds { get => this.mCustomRewardedAdIds; set => this.mCustomRewardedAdIds = value as Dictionary_AdPlacement_AdId; }
    ...
    public class AmazonApplovinSetting
    {
        ...
        [SerializeField] [LabelText("MREC")] [BoxGroup("Amazon Id")] private CrossPlatformValue amazonMRecAdId;

        [SerializeField] [LabelText("Interstitial")] [BoxGroup("Amazon Id")] private CrossPlatformValue amazonInterstitialAdId;

        [SerializeField] [LabelText("Rewarded")] [BoxGroup("Amazon Id")] private CrossPlatformValue amazonRewardedAdId;
