namespace ServiceImplementation.FBInstant.Player
{
    ...
    public static class FBPlayer
    {
        ...
        [DllImport("__Internal")]
        public static extern void SaveUserData(string key, string json, string callbackObj, string callbackFunc);

        [DllImport("__Internal")]
        public static extern void LoadUserData(string key, string callbackObj, string callbackFunc);
