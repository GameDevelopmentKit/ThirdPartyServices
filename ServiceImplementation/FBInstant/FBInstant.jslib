...
var LibraryMyFBPlugin = {
    ...
    var requestSuccessFuncName = "RequestShowInterstitialAdSucceed";
    ...
    fbinstant_showRewardedVideoAsync: function(){
      var requestSucceedFuncName = "RequestShowRewardAdSucceed";
      ...
      if (ad == null){
        ...
        ad.showAsync().then(function() {
        MyAdInstance.rewardedAd = null;
              MyGameInstance.SendMessage(eventHandlerGameObjectName, requestSucceedFuncName);
        }).catch(function(err) {
                  FBInstant.logEvent(err.code, 1, FBInstant.getEntryPointData());
